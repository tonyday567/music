...
> playEvent insts me = 
>     let x = Map.lookup (eInst me) (Map.fromList insts)
>         eSyn = maybe defaultSynth identity x
...
>     if os == "mingw32" then writeNRT outFile (playMEvs t 0 $ perform m)
